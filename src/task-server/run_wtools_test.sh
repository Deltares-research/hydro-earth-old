...
export TRG_MODEL="$SCRIPTPATH/../file-server/results/test/$model_dir"
# export TRG_MODEL="./$model_dir"
mkdir $TRG_MODEL
...
echo "Starting: node ../../../../../ee-runner/ee-runner.js ../../../../wtools/scripts/srtm/download_SRTM.js $feature_table $hybas_id"
...
echo "Removing original elevation data $SRTM_DEM"
rm $SRTM_DEM
